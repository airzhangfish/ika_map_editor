...
private JLabel XLabel;
  ...
  public ScreenSelect() {
    ...
    p.add(red = new JScrollBar(Adjustable.HORIZONTAL, SDef.MO_X, 0, 0, 1000));
    red.setBlockIncrement(16);
    red.addAdjustmentListener(this);

    p.add(YLabel = new JLabel("Y坐标 " + SDef.MO_Y));
    p.add(green = new JScrollBar(Adjustable.HORIZONTAL, SDef.MO_Y, 0, 0, 1000));
